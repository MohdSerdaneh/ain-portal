...
//---hover account
function hoverr1(){
   image1.src ='/static/images/icons/dashboard/opposite/Group 183.svg';
    }
    function without_hover1(){
        image1.src = '/static/images/icons/dashboard/main page.svg';
    }
// function hoverr2(){
//     image2.src ='/static/images/icons/dashboard/opposite/ic_account_circle_24px.svg' ;
//     }
...
//     }
  //----hover-courses
  function hoverr3(){
   image3.src ='/static/images/icons/dashboard/opposite/Group 186.svg' ;
   console.log("sl");
  }
 ...
 //---hover exams
  function hoverr5(){
   image5.src ='/static/images/icons/dashboard/opposite/Group 184.svg' ;
   console.log("nl");
  }
